...
public:
	...
	void ConnectBoundariesById(const int domainOneIdx, const EFace domainOneFace, const int domainTwoIdx, const EFace domainTwoFace); // Sets two boundaries on two different domains to be connected, meaning that flow going out of one goes into the other (and vice versa).
